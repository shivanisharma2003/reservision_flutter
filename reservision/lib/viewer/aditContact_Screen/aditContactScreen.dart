...
import 'package:rservision/viewer/addContact_Screen/addContactScreen.dart';
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text("$firstName $lastName",style: TextStyle(fontSize: 17,fontWeight: FontWeight.w500,color: ConstColor.darkblack_Color),
            ),
            SizedBox(height: 12),
      ...
      child: Padding(
        ...
        child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
          children: [
            ...
            Text("$firstName",style: TextStyle(fontSize: 25,fontWeight: FontWeight.w600,color: ConstColor.white_Color),
            ),
            SizedBox(width: 55),

              TextButton(
                onPressed: (){
                  Navigator.push(context, MaterialPageRoute(builder: (context) => AddContactScreen( firstName: firstName,lastName: lastName,),));
                },
                child: Text(ConstString.edit_tex,style: TextStyle(fontSize: 15,fontWeight: FontWeight.w600,color: ConstColor.white_Color),
              )
            ),
          ],
        ),
